...
- Each nonblank output line must begin with one source marker, such as [E1]. E1 means the first selected-evidence item, E2 the second. Cite only a source that directly supports the line. If the evidence does not establish a detail, state that it is not yet known; do not create a detail.
