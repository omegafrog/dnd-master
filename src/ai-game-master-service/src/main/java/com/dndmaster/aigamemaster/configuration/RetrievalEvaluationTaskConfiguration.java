...
import com.dndmaster.aigamemaster.retrieval.RetrievalEvaluationCorpusValidator;
...
public class RetrievalEvaluationTaskConfiguration {
    ...
    ApplicationRunner retrievalEvaluationTask(
            ...
            @Value("${retrieval.evaluation.corpus-digest}") String corpusDigest,
            @Value("${retrieval.evaluation.embedding-model}") String embeddingModel,
            @Value("${retrieval.evaluation.index-version}") String indexVersion,
            @Value("${retrieval.evaluation.service-version}") String serviceVersion,
            @Value("${retrieval.evaluation.configuration-digest}") String configurationDigest) {
        return args -> {
