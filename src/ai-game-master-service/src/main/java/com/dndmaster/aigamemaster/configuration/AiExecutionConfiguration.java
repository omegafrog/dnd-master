...
public class AiExecutionConfiguration {
    ...
    AiExecutionPort aiExecutionPort(ObjectMapper mapper,
        ...
        return new RemoteAiExecutionPort(HttpClient.newBuilder().connectTimeout(Duration.ofSeconds(5)).build(), mapper, baseUri, token, timeout);
    }
}
