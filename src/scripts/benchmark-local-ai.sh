...
report=ai-game-master-service/build/test-results/localAiBenchmark/TEST-com.dndmaster.aigamemaster.LocalAiBenchmarkRouteTest.xml
if ! ./gradlew -q -Dspring.ai.ollama.base-url=http://localhost:11434 \
  :ai-game-master-service:localAiBenchmark --tests com.dndmaster.aigamemaster.LocalAiBenchmarkRouteTest \
