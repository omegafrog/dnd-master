...
public record EvalRunReport(String reportSchemaVersion, EvalRunConfiguration configuration,
    ...
    public record HardRate(long pass, long failure, long unevaluated) { public double passRate() { return denominator() == 0 ? 0 : (double) pass / denominator(); } public long denominator() { return pass + failure + unevaluated; } }
}
