...
public record CombatMapSpatialActionCommand(UUID adventureId, UUID mapId, UUID ownerPlayerId, UUID tokenId,
        CombatMapPreviewPosition cell, long expectedVersion, UUID commandId) {
    public CombatMapSpatialActionCommand(UUID mapId, UUID ownerPlayerId, UUID tokenId,
            CombatMapPreviewPosition cell, long expectedVersion, UUID commandId) {
        this(null, mapId, ownerPlayerId, tokenId, cell, expectedVersion, commandId);
    }
