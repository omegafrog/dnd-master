...
public final class StoryContinuityToolRegistry {
    ...
    public static Set<GmToolDefinition> definitions(OfficialToolPort reviseStoryPlan, OfficialToolPort advanceGameTime) {
        ...
        String timeSchema = "{\"type\":\"object\",\"required\":[\"commandId\",\"sessionId\",\"turnId\",\"turns\",\"expectedClockVersion\"],\"properties\":{\"commandId\":{\"type\":\"string\"},\"sessionId\":{\"type\":\"string\"},\"turnId\":{\"type\":\"string\"},\"turns\":{\"type\":\"integer\"},\"expectedClockVersion\":{\"type\":\"integer\"},\"ruleSecondsPerTurn\":{\"type\":\"integer\"}}}";
