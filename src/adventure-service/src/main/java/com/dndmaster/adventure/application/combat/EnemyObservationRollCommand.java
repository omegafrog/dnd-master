...
public record EnemyObservationRollCommand(UUID adventureId, UUID mapId, UUID sessionId, RuleSetId ruleSetId,
        UUID ownerPlayerId, UUID turnId, UUID checkId, UUID operationId, UUID commandId, String ruleReference,
    ...
    public EnemyObservationRollCommand {
        ...
        Objects.requireNonNull(turnId); Objects.requireNonNull(operationId); Objects.requireNonNull(commandId);
    ...
    public EnemyObservationRollCommand withRule(CombatMapCheckDetails details) {
        return new EnemyObservationRollCommand(adventureId, mapId, sessionId, ruleSetId, ownerPlayerId, turnId, checkId,
