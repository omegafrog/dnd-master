...
public record EvidenceSufficiencyRequest(String policyId, String query, List<EvidenceCandidate> candidates, List<UUID> pinnedEvidenceIds, int additionalSearches) {
