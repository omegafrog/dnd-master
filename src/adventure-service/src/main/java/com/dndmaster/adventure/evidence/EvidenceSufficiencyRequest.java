...
public record EvidenceSufficiencyRequest(String policyId, String query, List<EvidenceCandidate> candidates, List<UUID> pinnedEvidenceIds, int additionalSearches, UUID soloPlayerId) {
 public EvidenceSufficiencyRequest(String policyId, String query, List<EvidenceCandidate> candidates, List<UUID> pinnedEvidenceIds) {
  this(policyId, query, candidates, pinnedEvidenceIds, 0, null);
 }
 public EvidenceSufficiencyRequest(String policyId, String query, List<EvidenceCandidate> candidates, List<UUID> pinnedEvidenceIds, int additionalSearches) {
  this(policyId, query, candidates, pinnedEvidenceIds, additionalSearches, null);
 }
