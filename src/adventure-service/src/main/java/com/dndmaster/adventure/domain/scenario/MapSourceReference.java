...
public record MapSourceReference(KnowledgeDocumentId knowledgeDocumentId, long extractionVersion, String locator,
        String scenarioPackageVersion) {
    public MapSourceReference(KnowledgeDocumentId knowledgeDocumentId, long extractionVersion, String locator) {
        this(knowledgeDocumentId, extractionVersion, locator, "");
    }
    ...
    public MapSourceReference {
        ...
        scenarioPackageVersion = scenarioPackageVersion == null ? "" : scenarioPackageVersion.trim();
    }
}
