...
export const weaponOptions: WeaponDefinition[] = [
  ...
  { id: 'dagger', label: '대거', damage: '1d4', damageType: '관통', category: 'SIMPLE', kind: 'MELEE', finesse: true, range: '20/60ft' },
  { id: 'greatclub', label: '그레이트클럽', damage: '1d8', damageType: '타격', category: 'SIMPLE', kind: 'MELEE' },
  { id: 'handaxe', label: '핸드액스', damage: '1d6', damageType: '참격', category: 'SIMPLE', kind: 'MELEE', range: '20/60ft' },
  { id: 'javelin', label: '재블린', damage: '1d6', damageType: '관통', category: 'SIMPLE', kind: 'MELEE', range: '30/120ft' },
  { id: 'light-hammer', label: '라이트 해머', damage: '1d4', damageType: '타격', category: 'SIMPLE', kind: 'MELEE', range: '20/60ft' },
  { id: 'mace', label: '메이스', damage: '1d6', damageType: '타격', category: 'SIMPLE', kind: 'MELEE' },
  { id: 'quarterstaff', label: '쿼터스태프', damage: '1d6', damageType: '타격', category: 'SIMPLE', kind: 'MELEE' },
  { id: 'sickle', label: '낫', damage: '1d4', damageType: '참격', category: 'SIMPLE', kind: 'MELEE' },
  { id: 'spear', label: '창', damage: '1d6', damageType: '관통', category: 'SIMPLE', kind: 'MELEE', range: '20/60ft' },
  { id: 'light-crossbow', label: '라이트 크로스보우', damage: '1d8', damageType: '관통', category: 'SIMPLE', kind: 'RANGED', range: '80/320ft' },
  { id: 'dart', label: '다트', damage: '1d4', damageType: '관통', category: 'SIMPLE', kind: 'RANGED', finesse: true, range: '20/60ft' },
  { id: 'shortbow', label: '단궁', damage: '1d6', damageType: '관통', category: 'SIMPLE', kind: 'RANGED', range: '80/320ft' },
  { id: 'sling', label: '슬링', damage: '1d4', damageType: '타격', category: 'SIMPLE', kind: 'RANGED', range: '30/120ft' },
  { id: 'battleaxe', label: '배틀액스', damage: '1d8', damageType: '참격', category: 'MARTIAL', kind: 'MELEE' },
  { id: 'greataxe', label: '그레이트액스', damage: '1d12', damageType: '참격', category: 'MARTIAL', kind: 'MELEE' },
  { id: 'greatsword', label: '그레이트소드', damage: '2d6', damageType: '참격', category: 'MARTIAL', kind: 'MELEE' },
  { id: 'longsword', label: '롱소드', damage: '1d8', damageType: '참격', category: 'MARTIAL', kind: 'MELEE' },
  ...
  { id: 'warhammer', label: '워해머', damage: '1d8', damageType: '타격', category: 'MARTIAL', kind: 'MELEE' },
  { id: 'longbow', label: '장궁', damage: '1d8', damageType: '관통', category: 'MARTIAL', kind: 'RANGED', range: '150/600ft' },
  { id: 'hand-crossbow', label: '핸드 크로스보우', damage: '1d6', damageType: '관통', category: 'MARTIAL', kind: 'RANGED', range: '30/120ft' },
]
