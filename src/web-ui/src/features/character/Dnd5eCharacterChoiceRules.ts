...
const backgroundRules: Record<string, BackgroundRule> = {
  복사: { feature: { name: '신도의 안식처', description: '같은 신앙의 사원과 신도에게서 기본적인 도움과 보호를 받을 수 있습니다.' }, choiceRequirements: [choice('background-languages', '배경 추가 언어', 2, languageOptions)] },
  ...
  '시골 영웅': { feature: { name: '소박한 환대', description: '평범한 사람들이 숨겨 주거나 쉬게 해 주고 위험에서 보호하려 합니다.' }, choiceRequirements: [choice('background-artisan-tool', '장인 도구 숙련', 1, artisanToolOptions)] },
  ...
  학자: { feature: { name: '연구자', description: '모르는 지식이 있을 때 그 정보를 찾을 장소나 사람을 압니다.' }, choiceRequirements: [choice('background-languages', '배경 추가 언어', 2, languageOptions)] },
