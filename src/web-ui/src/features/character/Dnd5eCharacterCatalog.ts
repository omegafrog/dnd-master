...
const allSkills = ['곡예', '손속임', '은신', '비전학', '수사', '역사', '자연', '종교', '동물 조련', '통찰', '의학', '지각', '생존', '기만', '위협', '공연', '설득', '운동']
export const classOptions: ClassOption[] = [
  ...
  { id: '로그', label: '로그', description: '기술, 잠입, 기습 공격에 능한 전문가입니다.', hitDie: 'd8', savingThrows: ['dexterity', 'intelligence'], skillChoiceCount: 4, skillChoices: ['곡예', '운동', '기만', '통찰', '위협', '수사', '지각', '공연', '설득', '손속임', '은신'], features: ['숙달', '암습 공격', '도둑의 속어'], subclassLevel: 3, canCastSpells: false, cantrips: [], firstLevelSpells: [] },
  ...
  { id: '위저드', label: '위저드', description: '주문책을 연구해 폭넓은 비전 마법을 사용하는 학자입니다.', hitDie: 'd6', savingThrows: ['intelligence', 'wisdom'], skillChoiceCount: 2, skillChoices: ['비전학', '역사', '통찰', '수사', '의학', '종교'], features: ['주문시전', '비전 회복'], subclassLevel: 2, canCastSpells: true, cantrips: ['독 분사', '마법사의 손', '빛', '산성 거품', '서리 광선', '요술', '전격의 손아귀', '춤추는 빛', '하급 환영', '화염 화살'], firstLevelSpells: ['마법 갑주', '마법 탐지', '마법 화살', '방패', '수면', '식별', '언어 변환', '인간형 매혹', '자기 위장', '조용한 영상', '천둥파도', '타오르는 손길'] },
...
export const backgroundOptions: BackgroundOption[] = [
  bg('복사', '신전이나 종교 공동체에서 봉사하고 신앙을 배운 인물입니다.', ['통찰', '종교'], ['성표', '기도서', '향 5개', '평상복', '15gp']),
  ...
  bg('학자', '학문과 연구를 통해 지식을 축적한 인물입니다.', ['비전학', '역사'], ['잉크병', '깃펜', '작은 칼', '편지', '평상복', '10gp']),
