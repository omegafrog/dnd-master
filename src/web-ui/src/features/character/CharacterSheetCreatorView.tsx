...
const spellDescriptions: Record<string, string> = {
  ...
  "전격의 손아귀": "대상을 붙잡는 전격을 내뿜어 번개 피해를 줍니다.",
  ...
  "신성한 불길": "대상이 민첩 내성 굴림에 실패하면 광휘 피해를 입습니다.",
...
const backgroundFeatureHelp: Record<string, string> = {
  ...
  "시골 영웅": "평민 공동체에서 환대와 은신처를 받을 수 있습니다.",
  ...
  학자: "지식과 관련된 정보를 조사하고 기억하는 데 능숙합니다.",
  ...
  async function save() {
    ...
    try {
      ...
      await onSave({
        ...
        background: effectiveBackground || "학자",
