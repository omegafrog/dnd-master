...
public record MovementCheckResult(UUID commandId, UUID operationId, UUID checkId, boolean success, MovementCheckOwner owner) {
    public MovementCheckResult(UUID operationId, UUID checkId, boolean success, MovementCheckOwner owner) {
        this(checkId, operationId, checkId, success, owner);
    }
    ...
    public MovementCheckResult(UUID operationId, UUID checkId, boolean success, PlayerId ownerPlayerId) {
        this(checkId, operationId, checkId, success, MovementCheckOwner.player(ownerPlayerId));
    }
}
