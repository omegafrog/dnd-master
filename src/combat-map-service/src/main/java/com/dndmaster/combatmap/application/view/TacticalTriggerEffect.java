...
public record TacticalTriggerEffect(String triggerId, Kind kind, List<String> targetIds, boolean planned, String transitionId) {
    public TacticalTriggerEffect(String triggerId, Kind kind, List<String> targetIds, boolean planned) {
        this(triggerId, kind, targetIds, planned, "");
    }
