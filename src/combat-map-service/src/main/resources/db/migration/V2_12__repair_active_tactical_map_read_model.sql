-- Adventure V59 can recreate this shared read model without the Combat Map
-- columns. Repair it in the owning Combat Map migration stream before queries
-- or activation transactions use the table.
