-- The scenario-runtime cutover removes the adventure-owned binding, but the
-- combat-map player projection still needs a stage-scoped active-map read model.
-- Keep ownership here so the combat-map module can recreate it after V59.
