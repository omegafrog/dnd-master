-- Adventure V59 can run after combat-map V2.10 because each module owns a
-- separate Flyway history. Re-assert the read model at the next combat-map
-- migration so existing databases cannot be left without the binding table.
