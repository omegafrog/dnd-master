...
- Phase 6: in progress; equipment, spell, skill, and expertise controls have been extracted and connected.
...
- [~] Split `CharacterCreationPage` into step components.
  ...
  - [ ] Extract identity, class and subclass selection, ability scores, roleplay, derived preview, and party steps.
