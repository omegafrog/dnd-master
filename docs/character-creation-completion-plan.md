...
- Phase 6: in progress; equipment loadout and spell selection have been extracted and connected.
...
- [~] Split `CharacterCreationPage` into step components.
  ...
  - [ ] Extract identity, class skills and expertise, ability scores, roleplay, derived preview, and party steps.
