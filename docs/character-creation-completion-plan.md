...
- Phase 6: in progress; equipment loadout UI has been extracted and connected.
...
- [~] Split `CharacterCreationPage` into step components.
  ...
  - [ ] Extract identity, class choices, spells, ability scores, roleplay, derived preview, and party steps.
