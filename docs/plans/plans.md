...
|---|---:|---|---|---|
| [220](220-planning-diagnostics-compatibility.md) | #220 | `ready-for-agent` | #219 completed | diagnostics, legacy replay, duplicate/retry compatibility |
| [GMQ-001](GMQ-001-prompt-registry-baseline.md) | [#231](https://github.com/omegafrog/dnd-master/issues/231) / #210 | `planned` | #220 | role registry, baseline, split contract |
