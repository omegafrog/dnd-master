...
| [RAG-015](rag-015-published-preprocessing-vector-publication.md) | [#191](https://github.com/omegafrog/dnd-master/issues/191) | ready-for-agent | RAG-014 | 검증된 산출물만 provenance와 함께 pgvector에 공개한다. |
...
Dependency graph evaluated on 2026-08-26. RAG-014 is completed, so RAG-015 is now `ready-for-agent`. RAG-016 and RAG-017 remain `planned` until their listed RAG-015 prerequisite is completed.
