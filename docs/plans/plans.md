...
| [RAG-009 Regional Column Reading Order](rag-009-regional-column-reading-order.md) | [#182](https://github.com/omegafrog/dnd-master/issues/182) | `ready-for-agent` | RAG-008 | layout regions, column hypotheses/profile, spanning-block reading order |
