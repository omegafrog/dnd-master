...
| [RAG-022](rag-022-bounded-evidence-and-claim-citations.md) | [#197](https://github.com/omegafrog/dnd-master/issues/197) | `ready-for-agent` | RAG-021 | 현재 단계와 행동 의도에 맞는 최대 8개 근거만 전달하고 응답 주장과 인용의 관련성을 검증한다. |
...
`RAG-020`, `RAG-021`, and `RAG-023` are completed. Completion of RAG-021 promotes its dependent `RAG-022` to `ready-for-agent`; completion of RAG-023 keeps RAG-024 `ready-for-agent`. RAG-025 and RAG-026 remain `planned` until every listed dependency is `completed`.
