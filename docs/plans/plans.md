...
| [RAG-003 Dense Baseline](rag-003-dense-baseline.md) | `ready-for-agent` | RAG-002 | injected Dense adapter and baseline artifacts |
| [RAG-004 BM25 Baseline](rag-004-bm25-baseline.md) | `ready-for-agent` | RAG-002 | BM25 adapter and baseline artifacts |
