...
3. [036-3 스토리북 제안 사용·제외 흐름](036-3-storybook-proposal-decision-flow.md) — [#164](https://github.com/omegafrog/dnd-master/issues/164) — `planned`
4. [036-4 설정 확정·게시·캐릭터 생성 연계](036-4-publish-and-character-creation-entry.md) — [#165](https://github.com/omegafrog/dnd-master/issues/165) — `planned`
