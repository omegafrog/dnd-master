...
| [RAG-016](rag-016-published-evidence-scenario-story-plan.md) | [#192](https://github.com/omegafrog/dnd-master/issues/192) | ready-for-agent | RAG-015 | 공개 RAG 근거를 시나리오와 모험 계획 인용으로 전파한다. |
...
Dependency graph evaluated on 2026-08-26. RAG-014 and RAG-015 are completed, so RAG-016 and RAG-017 are now `ready-for-agent`.
