...
| [RAG-012 Layout Validation Publication Gate](rag-012-layout-validation-publication-gate.md) | [#185](https://github.com/omegafrog/dnd-master/issues/185) | `ready-for-agent` | RAG-010, RAG-011 | render validation, multidimensional confidence, page/version gate |
