...
`RAG-020`, `RAG-021`, `RAG-022`, and `RAG-023` are completed. Completion of RAG-023 keeps RAG-024 `ready-for-agent`; RAG-025 and RAG-026 remain `planned` until every listed dependency is `completed`.
