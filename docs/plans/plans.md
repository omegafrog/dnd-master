...
| [RAG-019](rag-019-bounded-projection-repair.md) | — | completed | RAG-018 | 구조화 projection 위반을 bounded repair·재생성·정직한 실패로 처리한다. |

## Dependency decision

Dependency graph evaluated on 2026-08-27. RAG-014 through RAG-018 and RAG-019 implementation plus independent Standards/Spec review are completed.
