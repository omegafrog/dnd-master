...
- Added a zero-result scope preflight through the real rule/story adapters before the scored run; seeded owner/document/type/version/index checks therefore fail before evaluation.
