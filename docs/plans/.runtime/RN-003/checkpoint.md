...
remediation_evidence: "Production verification context is built from resolved plan, actor-scoped state, and evidence; retry presentation uses the bounded verification/rewrite gate; focused tests pass."
