...
| 구성요소 | 책임 | 금지 |
| --- | --- | --- |
| `MapGridAlignmentEditor` — 격자 맞춤 편집 화면 | 3단계 초안, 확대경, 적용·취소·재시도 | 게임 턴 변경 |
| `MapPreparationEditor` — 맵 초안 검수 화면 | AI 벽·문 검수, 자르기, 격자 맞춤, 저장 전 검증 | AI 제안을 사용자 확정 없이 적용 |
...
금지: 기존 게임 칸 수·토큰 좌표 재배치, 보정에 따른 탐험/턴 변경, 격자 종류 확대, 새 배포 서비스. 맵 초안 검수 중 AI 제안을 사용자 확정 없이 적용하지 않는다.
