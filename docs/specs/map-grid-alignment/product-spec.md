...
기존 Tactical Map, Solo Player, Fog of War 의미를 유지한다. 본 명세의 ‘기준점’은 지도 격자에 맞추는 교차점, ‘한 칸 크기’는 이미지에서 한 격자 칸이 차지하는 크기, ‘미세 조정’은 떨어진 교차점의 오차를 줄이는 조작이다. 벽·문이 차지하는 ‘칸 경계선’은 CONTEXT.md에 기록한다.
