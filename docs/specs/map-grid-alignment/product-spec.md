...
- R7: 모험 시작 전에 AI가 제안한 벽·문을 사용자가 칸 단위로 수정하고 저장한다.
...
2. 사용자는 모든 칸을 확인해 벽을 추가·삭제하고 문 위치를 추가·삭제한다.
...
- B8: 벽·문은 유효한 게임 칸 안에 있어야 하며 같은 칸에 동시에 둘 수 없다. 플레이어 시작 칸은 벽이 될 수 없다.
